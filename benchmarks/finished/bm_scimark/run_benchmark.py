...
if __name__ == "__main__":
    ...
    # bench_SOR(100, 100, 10, Array2D)
    bench_SOR(50, 50, 5, Array2D)
    # bench_SparseMatMult(50 * 1000, 1000, 50 * 1000)
    bench_SparseMatMult(50 * 1000, 1000, 50 * 1000)
    # bench_MonteCarlo(100 * 1000, 100 * 1000)
    bench_MonteCarlo(50 * 1000, 50 * 1000)
    # bench_LU(100, 100)
    bench_LU(50, 50)
    # bench_FFT(1024, 50, 50)
    bench_FFT(512, 25, 25)
